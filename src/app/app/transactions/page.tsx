...
export default function TransactionsPage() {
  ...
  return (
    <section className="space-y-6">
      ...
      <form onSubmit={addTx} className="grid gap-3 rounded border border-white/10 bg-white/5 p-4 md:grid-cols-6">
        ...
        <div className="flex gap-2">
          <input className="w-full rounded border border-white/15 bg-black/20 p-3" placeholder="Valor (ex: 19,90)" value={amount} onChange={(e) => setAmount(e.target.value)} />
